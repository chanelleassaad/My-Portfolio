      ...
      <div className="flex gap-x-6">
        ...
        <div className="text-left">
          ...
          <p className="text-base text-gray-700 mt-2 ">
            I am a passionate computer engineer with experience in developing
            web applications and software solutions. My expertise includes
            front-end development with HTML, CSS, and JavaScript, as well as
            UI/UX design with Figma. I enjoy learning new technologies and
            solving complex problems.
          </p>
          <p className="text-base text-gray-700 mt-2">
            In my free time, I like to contribute to open-source projects and
            explore the latest trends in technology. I am dedicated to
            continuous learning and improvement, always striving to enhance my
